        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPubliclyDiscoverable = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGlobalAdmin = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeeLatitude = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HtmlColorCode = table.Column<string>(type: "TEXT", maxLength: 7, nullable: false, defaultValue: "#FFFFFF"),
                    RatingOut = table.Column<double>(type: "REAL", nullable: false),
                    SlopeOut = table.Column<int>(type: "INTEGER", nullable: false),
                    RatingIn = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalHandicap = table.Column<double>(type: "REAL", nullable: true),
                    GlobalHandicapUpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    TeeId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    HoleNumber = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizerId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ...
                    OrganizerPhone = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    CourseId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    TeeId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    AvatarUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    SeasonPoints = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInBag = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Nickname = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    LeagueHandicap = table.Column<double>(type: "REAL", nullable: true),
                    LeagueHandicapUpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaptainUserId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    CaptainName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CaptainEmail = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    CaptainPhone = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeasonId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    LeagueId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    LeagueGolferId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    GolferId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    TeamId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    SeasonHandicap = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Handicap = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    GolferId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    LeagueGolferId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    LeagueId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    CourseId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    TeeId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeasonEventId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    SeasonGolferId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    LeagueId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    RawScore = table.Column<int>(type: "INTEGER", nullable: true),
                    Handicap = table.Column<double>(type: "REAL", nullable: true),
                    NetScore = table.Column<double>(type: "REAL", nullable: true),
                    EventPoints = table.Column<double>(type: "REAL", nullable: true),
                    IsMissing = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    MissScore = table.Column<double>(type: "REAL", nullable: true),
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    TeamId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: true),
                    TeamName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoundId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    HoleNumber = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    GreenInRegulation = table.Column<bool>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weather = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Temperature = table.Column<int>(type: "INTEGER", nullable: true),
                    Wind = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    CourseConditions = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    PlayingPartners = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    SeasonEventId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    SeasonEventMatchId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    LeagueId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false),
                    HomeTeamId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: true),
                    HomeTeamName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    HomePoints = table.Column<double>(type: "REAL", nullable: true),
                    AwayTeamId = table.Column<string>(type: "TEXT", maxLength: 36, nullable: true),
                    AwayTeamName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    AwayPoints = table.Column<double>(type: "REAL", nullable: true),
                    IsComplete = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    StartingHole = table.Column<int>(type: "INTEGER", nullable: true),
                    StartingFlight = table.Column<int>(type: "INTEGER", nullable: true),
