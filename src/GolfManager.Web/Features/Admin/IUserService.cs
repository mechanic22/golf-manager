...
public interface IUserService
{
    ...
    /// </summary>
    Task<ApiResponse<UserProfileResponse>?> UpdateCurrentUserAsync(UpdateProfileRequest request);

    /// <summary>
    /// Get current user's aggregated golf statistics
    /// </summary>
    Task<ApiResponse<GolferStatsResponse>?> GetMyStatsAsync();
